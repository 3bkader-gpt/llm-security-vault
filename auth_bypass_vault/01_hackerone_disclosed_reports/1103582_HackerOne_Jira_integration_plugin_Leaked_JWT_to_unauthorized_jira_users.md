# Report #1103582: HackerOne Jira integration plugin Leaked JWT to unauthorized jira users

- **Platform:** HackerOne
- **Report URL:** [https://hackerone.com/reports/1103582](https://hackerone.com/reports/1103582)
- **Program:** HackerOne
- **Reporter:** @updatelap
- **Status:** RESOLVED
- **Severity:** medium
