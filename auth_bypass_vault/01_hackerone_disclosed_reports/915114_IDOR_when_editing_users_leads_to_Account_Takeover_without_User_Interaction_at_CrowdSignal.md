# Report #915114: IDOR when editing users leads to Account Takeover without User Interaction at CrowdSignal

- **Platform:** HackerOne
- **Report URL:** [https://hackerone.com/reports/915114](https://hackerone.com/reports/915114)
- **Program:** Automattic
- **Reporter:** @bugra
- **Status:** RESOLVED
- **Severity:** critical
