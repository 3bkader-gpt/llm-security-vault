# Report #143717: Change any Uber user's password through /rt/users/passwordless-signup - Account Takeover (critical)

- **Platform:** HackerOne
- **Report URL:** [https://hackerone.com/reports/143717](https://hackerone.com/reports/143717)
- **Program:** Uber
- **Reporter:** @mongo
- **Status:** RESOLVED
- **Severity:** None
