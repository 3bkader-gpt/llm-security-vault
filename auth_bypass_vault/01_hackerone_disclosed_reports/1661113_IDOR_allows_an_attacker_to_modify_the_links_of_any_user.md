# Report #1661113: IDOR allows an attacker to modify the links of any user

- **Platform:** HackerOne
- **Report URL:** [https://hackerone.com/reports/1661113](https://hackerone.com/reports/1661113)
- **Program:** Reddit
- **Reporter:** @criptex
- **Status:** RESOLVED
- **Severity:** high
